...
class App extends React.Component {
    ...
    componentDidMount() {
        ...
        // first renstate our localstorage
    ...
    addFish = fish => {
        ...
        // 2. Add our no fish to that fishes.
        fishes[`fish${Date.now()}`] = fish
        // 3. Set the new fishes objects to state.
    ...
    render() {
        return(
            <div className="catch-of-the-day">
                ...
                <Order {...this.state} fishes={this.state.fishes} order={this.state.order} removeFromOrder={this.removeFromOrder}/>
